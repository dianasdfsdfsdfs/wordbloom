    ...
    <Screen edges={['top', 'bottom']} style={styles.screen}>
      <View style={styles.hero}>
        ...
        <View style={styles.copy}>
          ...
          <Text variant="small" color="textSecondary" center style={styles.sub}>
...
const styles = StyleSheet.create({
  ...
  copy: { gap: spacing.sm, marginTop: spacing.xl, alignItems: 'center' },
  sub: { paddingHorizontal: spacing.md, maxWidth: 320 },
